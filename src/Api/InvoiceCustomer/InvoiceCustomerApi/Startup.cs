...
namespace InvoiceCustomerApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DbContexts>(opts => opts.UseSqlServer(Configuration.GetConnectionString("ApiDB")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "InvoiceCustomerApi v1"));
            }
